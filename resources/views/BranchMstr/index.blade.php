                ...
                <div class="card">
                    <div
                        ...
                        <div class="mb-2 mb-md-0">
                            <h4 class="card-title mb-0">Branch Master Data</h4>
                            <p class="card-subtitle mb-0">Manage your branch master entries</p>
                        </div>
                        <div class="ms-md-auto">
                            <button type="button" class="btn btn-outline-white btn-sm" data-bs-toggle="modal"
                                data-bs-target="#modalAddbranch">
                                <i class="bi bi-plus-circle me-1"></i> Add Branch Master
                            </button>
                        </div>
                    </div>
